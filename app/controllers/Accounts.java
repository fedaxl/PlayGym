  ...
  }  public static void logout()
{
  ...
  public static void register(String email, String firstname, String lastname, String password, String address,
                              String gender, double height, double startingweight)
  {
    Logger.info(firstname + " " + email);
    Member member = new Member(email, firstname, lastname, password, address, gender, height, startingweight);
    member.save();
    index();
  }
